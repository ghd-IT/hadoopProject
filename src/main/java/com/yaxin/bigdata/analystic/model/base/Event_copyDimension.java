...
public class Event_copyDimension extends BaseDimension {

    private  int  id;
    private String category;
    private String action;

    public Event_copyDimension() {
    }

    public Event_copyDimension(String category, String action) {
        this.category = category;
        this.action = action;
    }
    public Event_copyDimension(int id, String category, String action) {
    ...
    public  static EventDimension getInstance(String category,String action){
        ...
        return new EventDimension(category,action);
    }
    @Override
    public int compareTo(BaseDimension o) {
        ...
        Event_copyDimension other = (Event_copyDimension) o;
    ...
    public boolean equals(Object o) {
        ...
        Event_copyDimension that = (Event_copyDimension) o;
        return id == that.id &&
